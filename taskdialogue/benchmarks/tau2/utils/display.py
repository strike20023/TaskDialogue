...
from taskdialogue.benchmarks.tau2.data_model.simulation import RunConfig, SimulationRun
from taskdialogue.benchmarks.tau2.data_model.tasks import Action, Task
from taskdialogue.benchmarks.tau2.metrics.agent_metrics import AgentMetrics, is_successful
...
class ConsoleDisplay:
    ...
    def display_run_config(cls, config: RunConfig):
        ...
        # Print the layout
        cls.console.logger.info(layout)
    ...
    def display_task(cls, task: Task):
        ...
        cls.console.logger.info(task_panel)
    ...
    def display_agent_metrics(cls, metrics: AgentMetrics):
        ...
        cls.console.logger.info(metrics_panel)
