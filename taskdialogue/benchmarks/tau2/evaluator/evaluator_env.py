...
from taskdialogue.benchmarks.tau2.data_model.message import AssistantMessage, Message, ToolCall, UserMessage
from taskdialogue.benchmarks.tau2.data_model.simulation import DBCheck, EnvAssertionCheck, RewardInfo
...
from taskdialogue.benchmarks.tau2.evaluator.evaluator_base import EvaluatorBase
    ...
    def calculate_reward(
        ...
        for action in golden_actions:
            try:
                ...
                # Debug级别日志，避免干扰正常输出
                logger.debug(
                    f"Golden action execution: {action.name}({action.arguments}): {e}"
                )
